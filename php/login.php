...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($email === "" || $password === "") {
        ...
        $stmt = $mysqli->prepare(
            "SELECT id, first_name, last_name, password_hash, role, account_status, is_active
        ...
        if ($user && password_verify($password, $user["password_hash"])) {
            ...
            if ($status === "rejected") {
                $error = "Your account registration was declined. Please contact the admin.";
            ...
            <div class="auth-info">
                <img src="../includes/images.png" alt="COA Logo" class="logo"
                    style="width:64px; height:64px; border-radius:50%; object-fit:cover;
                           margin-bottom:24px; filter:drop-shadow(0 4px 10px rgba(255,255,255,0.2));">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-button">
                            ...
                            <button type="button" class="btn btn-auth-outline toggle-password"
                                ...
                                <svg class="eye-open eye-icon" fill="none" stroke="currentColor"
                                ...
                                <svg class="eye-closed eye-icon" fill="none" stroke="currentColor"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943
                                           ...
                                           5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132
                                           5.411m0 0L21 21" />
                                </svg>
                            </button>
                        </div>
